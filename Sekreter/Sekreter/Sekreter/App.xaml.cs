...
namespace Sekreter
{
    public partial class App
    {
        ...
        protected override async void OnInitialized()
        {
            ...
            await NavigationService.NavigateAsync("NavigationPage/ContactPage");
        }
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterForNavigation<OutlookPage, OutlookPageViewModel>();
        }
    }
}
